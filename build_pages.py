...
<div class="nav-overlay" aria-hidden="true">
  ...
  <div class="nav-overlay__footer"><span>Gloversal&trade; 2026</span><span>info@gloversal.com</span></div>
</div>
<main>
"""
  ...
  <div class="container container-wide">
    <div class="footer__grid">
      ...
      <div class="footer__col">
        ...
        <ul>
          <li><a href="mailto:info@gloversal.com" data-i18n="footer.general">General: info@gloversal.com</a></li>
          <li><a href="mailto:privacy@gloversal.com" data-i18n="footer.privacy">Privacy: privacy@gloversal.com</a></li>
          <li><a href="mailto:recruit@gloversal.com" data-i18n="footer.recruit">Recruit: recruit@gloversal.com</a></li>
        </ul>
      </div>
      <div class="footer__col">
      ...
      <div class="contact-intro reveal">
        ...
        <div class="contact-channels">
          <dl class="contact-channel">
            <dt data-i18n="contactPage.generalLabel">General</dt>
            <dd><a href="mailto:info@gloversal.com">info@gloversal.com</a></dd>
          </dl>
          <dl class="contact-channel">
            <dt data-i18n="contactPage.privacyLabel">Privacy</dt>
            <dd><a href="mailto:privacy@gloversal.com">privacy@gloversal.com</a></dd>
          </dl>
          <dl class="contact-channel">
            <dt data-i18n="contactPage.recruitLabel">Recruit</dt>
            <dd><a href="mailto:recruit@gloversal.com">recruit@gloversal.com</a></dd>
          </dl>
          <dl class="contact-channel">
